...
public final class AuthRepository {
    ...
    kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.Flow<? extends com.application.isyara.utils.state.Result<com.application.isyara.data.model.RegisterResponse>>> $completion) {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.Flow<? extends com.application.isyara.utils.state.Result<com.application.isyara.data.model.OtpResponse>>> $completion) {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.Flow<? extends com.application.isyara.utils.state.Result<com.application.isyara.data.model.LoginResponse>>> $completion) {
        return null;
    }
    ...
    java.lang.String token, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.Flow<? extends com.application.isyara.utils.state.Result<com.application.isyara.data.model.ResendOtpResponse>>> $completion) {
        return null;
    }
    
    @org.jetbrains.annotations.Nullable()
    public final java.lang.Object resetPassword(@org.jetbrains.annotations.NotNull()
    com.application.isyara.data.model.ResetPasswordRequest resetPasswordRequest, @org.jetbrains.annotations.NotNull()
    java.lang.String token, @org.jetbrains.annotations.NotNull()
